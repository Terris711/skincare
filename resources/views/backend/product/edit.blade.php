        ...
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              @foreach($items as $item)              
                ...
                // dd($data);
                @endphp
              <option value="30ml"  @if( in_array( "30ml",$data ) ) selected @endif>30ml</option>
              <option value="60ml"  @if( in_array( "60ml",$data ) ) selected @endif>60ml</option>
              <option value="120ml"  @if( in_array( "120ml",$data ) ) selected @endif>120ml</option>
              <option value="20ml"  @if( in_array( "20ml",$data ) ) selected @endif>20ml</option>
              @endforeach
          </select>
        </div>
        <div class="form-group">
